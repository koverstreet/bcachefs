...
static void bch2_invalidatepage(struct page *page, unsigned int offset,
				unsigned int length)
{
	bch2_invalidate_folio(page_folio(page), offset, length);
}

static int bch2_releasepage(struct page *page, gfp_t gfp_mask)
{
	return bch2_release_folio(page_folio(page), gfp_mask);
}
