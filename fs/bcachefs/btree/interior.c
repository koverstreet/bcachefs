...
static void bch2_btree_update_add_node(btree_update_nodes *nodes, struct btree *b, bool root)
{
						      ...
						      struct btree *b)
{
	...
	bch2_btree_update_add_node(&as->old_nodes, b, false);
}
		       ...
		       struct keylist *keys)
{
	...
	if (n3) {
		...
		bch2_btree_update_add_node(&as->new_nodes, n3, true);
	}
	if (n2) {
		bch2_btree_update_get_open_buckets(as, n2);
		bch2_btree_node_write_trans(trans, n2, SIX_LOCK_intent, 0);
		bch2_btree_update_add_node(&as->new_nodes, n2, false);
	}
				   ...
				   btree_path_idx_t path_idx)
{
	...
	bch2_btree_update_add_node(&as->new_nodes, n, true);
