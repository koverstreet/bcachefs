...
#define __darray_resize_gfp(_d, _element_size, _new_size, _gfp)			\
	alloc_hooks(__bch2_darray_resize((_d), _element_size, (_new_size), _gfp))

#define darray_resize_gfp(_d, _new_size, _gfp)					\
	(unlikely(_new_size > (_d)->size)					\
	 ? __darray_resize_gfp((darray_char *) (_d), sizeof((_d)->data[0]),	\
			       (_new_size), _gfp)				\
	 : 0)
