...
#define BCH_METADATA_VERSIONS()						\
	...
	x(directory_size_v2,		BCH_VERSION(1, 26))
...
LE64_BITMASK(BCH_SB_IO_ERROR_THRESHOLD,	struct bch_sb, flags[6], 22, 38);
LE64_BITMASK(BCH_SB_LAST_FSCK_VERSION,	struct bch_sb, flags[6], 38, 54);
LE64_BITMASK(BCH_SB_CSUM_BLOCKSIZE,	struct bch_sb, flags[6], 54, 62);
