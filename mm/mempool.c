...
/**
 * mempool_alloc_preallocated_noprof - allocate an element from preallocated elements
 ...
 * available.
 */
void *mempool_alloc_preallocated_noprof(mempool_t *pool)
{
	void *element;
	unsigned long flags;
...
EXPORT_SYMBOL(mempool_alloc_preallocated_noprof);
