...
extern void *mempool_alloc_preallocated_noprof(mempool_t *pool) __malloc;
#define mempool_alloc_preallocated(...)					\
	alloc_hooks(mempool_alloc_preallocated_noprof(__VA_ARGS__))
